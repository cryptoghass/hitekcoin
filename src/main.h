...
static const int64_t MIN_RELAY_TX_FEE = 0.0001 * COIN;
static const int64_t MIN_TXOUT_AMOUNT = 0.0001 * COIN;

static const int64_t MAX_MONEY = 100000000000 * COIN;
...
static const uint256 hashGenesisBlock("0x0000033cca89c665f1f2c924a95ef016644c9cdf3464399542875ea3b72353b0");
static const uint256 hashGenesisBlockTestNet("0x000c763e402f2436da9ed36c7286f62c3f6e5dbafce9ff289bd43d7459327eb");

inline int64_t PastDrift(int64_t nTime)   { return nTime - ((1 * 3 + 10) * 60); } // up to this from the past
...
public:
    ...
    {
        // Protocol switch to support p2pool at Hi-TEK block #0
        ...
        // Before Hi-TEK block #0 - get from pregenerated table
